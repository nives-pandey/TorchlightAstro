  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-bold text-yellow-400 mb-4">Choose Your Cosmic Journey</h2>
          ...
          <Card key={tier.name} className={`cosmic-card relative ${tier.popular ? 'ring-2 ring-yellow-400' : ''}`}>
            ...
            <CardHeader className="text-center pb-4">
              <div className="flex items-center justify-center mb-3">
                <tier.icon className="h-8 w-8 text-yellow-400" />
              </div>
              <CardTitle className="text-xl text-yellow-400">{tier.name}</CardTitle>
              <div className="mt-4">
      ...
      <Card className="cosmic-card">
        <CardHeader>
          <CardTitle className="text-yellow-400 text-center">Complete Feature Comparison</CardTitle>
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-700">
                  ...
                  <th className="text-center py-3 px-4 text-yellow-400">Cosmic Navigator</th>
