...
function CryptoPaymentView({ 
  ...
  return (
    <div className="space-y-6">
      ...
      {/* QR Code Placeholder */}
      <div className="bg-white dark:bg-gray-800 p-8 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600">
...
export default function UniversalPaymentModal({ 
  ...
  const renderMethodSelection = () => (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          Contributing <span className="font-bold text-purple-600">${amount}</span> for {purpose}
        </p>
      </div>
      ...
      <Tabs defaultValue="popular" className="w-full">
        ...
        <TabsContent value="popular" className="space-y-3 mt-6">
          {paymentMethods.filter(m => 
            ...
            <Card
              key={method.id}
              className="cursor-pointer transition-all duration-200 hover:shadow-lg hover:scale-[1.02] border-2 hover:border-purple-300"
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl mx-4 bg-white dark:bg-gray-900 border border-purple-200/50 shadow-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
