      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <h1 className="text-5xl font-bold bg-gradient-to-r from-yellow-400 to-yellow-500 bg-clip-text text-transparent">
        ...
        <Card className="sanctuary-card mb-12">
          <CardHeader>
            <CardTitle className="text-yellow-600 text-center text-2xl">
        ...
        <Card className="sanctuary-card mb-12">
          <CardHeader>
            <CardTitle className="text-yellow-600 flex items-center justify-center space-x-3 text-2xl">
          ...
          <CardContent className="text-gray-300 space-y-6">
            <div className="text-center mb-8">
              <p className="text-lg leading-relaxed">
                <strong className="text-yellow-500">Torchlight</strong> serves as your personal cosmic illuminator, 
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm">
                  ...
                  <strong className="text-yellow-500"> all final decisions remain entirely yours</strong>. 
